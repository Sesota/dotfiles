...
alias ll="ls -lha"
alias v="nvim"
alias confedit="nvim ~/dotfiles-sepehr"
alias tmux="tmux -L sepehr -f ~/dotfiles-sepehr/.tmux.conf"
...
[ -f ~/dotfiles-sepehr/.zsh_theme.sh ] && source ~/dotfiles-sepehr/.zsh_theme.sh
